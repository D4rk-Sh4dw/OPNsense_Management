      ...
      {diffResult && (
        <div className="fixed inset-0 z-40 bg-black/60 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col">
            {/* Header - stays fixed */}
            <div className="flex-shrink-0 p-6 border-b flex items-center justify-between gap-4">
              <div>
            ...
            {/* Scrollable content */}
            <div className="flex-1 overflow-y-auto min-h-0 p-4 bg-gray-950 font-mono text-xs">
