...
function ConfigHistoryTabPanel({ configHistory, loading, error, onRefresh, onSync, firewallId, configHistoryAPI }) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-b-lg shadow-md flex flex-col max-h-[600px]">
      {/* Sticky Header */}
      <div className="flex-shrink-0 sticky top-0 z-30 bg-white dark:bg-gray-800 p-6 pb-4 border-b dark:border-gray-700 shadow-md">
